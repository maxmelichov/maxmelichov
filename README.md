<div align="center">
  ...
  <p>
    ...
    <br />
    Building ultra-low-latency AI systems. Expert in optimizing PyTorch/ONNX pipelines for Edge & Enterprise.
  </p>
  ...
  <table width="90%">
    <tr>
      <td width="100%" align="center">
        ...
        <p>
          A studio-quality (44.1kHz) Hebrew speech synthesis model engineered for <strong>extreme inference performance</strong>. 
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🎧 MamreVoice (2B Params)</h3>
      <p>
        <strong>DiffMamba-based TTS.</strong> An end-to-end engine designed for expressive prosody and zero-shot cloning. The 2B-parameter architecture ensures high-fidelity output.
      </p>
      <a href="https://maxmelichov.github.io/mamre-site/"><strong>➡️ View Demo</strong></a>
    </td>
    <td width="50%" valign="top">
      <h3>🔡 Phonikud (NLP)</h3>
      <p>
        <strong>DictaBert-based Diacritization.</strong> A modern Hebrew Niqqud model leveraging DictaBert and PyTorch for superior accuracy. Features a stable, efficient end-to-end training loop.
      </p>
      <a href="https://thewh1teagle.github.io/phonikud-paper/"><strong>➡️ Read Paper</strong></a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🩺 RSNA 2025 (Medical Vision)</h3>
      <p>
        <strong>Lumbar Spine Detection (Top 6%).</strong> A level-aware 2.5D/3D transformer pipeline for spinal stenosis grading. Ranked 103/1900 in the global Kaggle challenge.
      </p>
      <em>🥉 Kaggle Bronze Medal</em>
    </td>
    <td width="50%" valign="top">
      <h3>🐦 BirdCLEF 2025 (Bioacoustics)</h3>
      <p>
        <strong>Large Scale Audio Classification (Top 2%).</strong> An efficient pipeline achieving 0.902 AUC. Utilizes weighted-blend ensembling and optimized feature extraction.
      </p>
      <em>🥈 Kaggle Silver Medal</em>
    </td>
  </tr>
</table>
